...
class Question:
    ...
    def get_answers(self, boxes, tresh=197):
        ...
        -------
        tuple of lists
            The first element is the list of booleans for the answers of the
            questions. And the second element is the error message if something
            is not correct.
        """
        n = len(self.coords)
        answers = [0]*n
